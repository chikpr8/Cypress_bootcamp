...
describe('My First Test Suite - Day 2', () => {
   ...
   it('Common chaining methods in cypress locators', () => {
                ...
                // cy.get('form[action="/signup"]').find('input[type="email"]').first().type('Password123');
                ...
                //  cy.get('form[action="/signup"]').children('input[type="email"]').type('Password123');


                // .parent():-cy.get('input[data-qa="signup-name"]').parent().find('input[data-qa="signup-name"]').type('Parent Input');
